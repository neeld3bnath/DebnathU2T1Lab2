...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        System.out.printf("Rectangle 1's area: %s, Box Volume: %s", rect1.calculateArea(), rect1.calculateBoxVolume(rect1Height));
        System.out.printf("Rectangle 2's area: %s, Box Volume: %s", rect2.calculateArea(), rect2.calculateBoxVolume(rect2Height));
    }
}
